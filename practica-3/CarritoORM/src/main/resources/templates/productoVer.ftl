    ...
    <div class="container" style="margin-top: 8rem; padding: 2rem; background: #D3D3D3; border-radius: 10px; max-width: 50rem">
        <div class="row">
            <div class="col">
                ...
                <form class="col" enctype="application/x-www-form-urlencoded" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly="readonly" type="url" name="urlFoto" value="${datos.fotosBase64[0]}"
            ...
            <div class="container col">
                <div id="C-${datos.id}" class="carousel slide" data-bs-ride="carousel", style="height: 30rem; width: 20rem">
                    <div class="carousel-inner">
                        <#list datos.fotosBase64 as imagen>
                            <div class="carousel-item <#if imagen_index == 0> active</#if>">
                                <img style="object-fit: cover; height: 30rem; width: 20rem;" src="data:image/${imagen.type};base64,${imagen.foto}" alt="imagen-${imagen_index}">
                            </div>
                        </#list>
                    </div>
                    <a class="carousel-control-prev" data-bs-target="#C-${datos.id}" role="button" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Anterior</span>
                    </a>
                    <a class="carousel-control-next" data-bs-target="#C-${datos.id}" role="button" data-bs-slide="next">
