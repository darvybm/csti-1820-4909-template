                ...
                <table class="table table-striped">
                    ...
                    <#list venta.carritoItems as carritoItem>
                        <tr>
                            ...
                            <td><img src="data:image/${carritoItem.getProducto().fotosBase64[0].type};base64,${carritoItem.getProducto().fotosBase64[0].foto}" style="height: 8rem; width: 6rem; object-fit: cover"></td>
                        </tr>
                    </#list>
                    </tbody>
                    <tfoot>
    ...
    <#else>
        <div class="container text-center">
            ...
            <div class="mt-3">
                ...
                <a href="/carrito/administrar/producto" class="btn btn-success mt-2">Administrar Productos</a>
            </div>
        </div>
    </#if>
</div>
