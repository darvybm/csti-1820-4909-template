...
<div class="container-fluid" style="margin-top: 7rem">
    <div class="row justify-content-center">
        <div class="col">
            <div class="p-4"
                 style="box-shadow: 0 0 20px rgba(0, 0, 0, 0.1); background-color: #e5e5e5; border-radius: 20px;">
                <div class="container text-center">
                    <img class="img-fluid" src="/img/animeCafe.gif" style="object-fit: scale-down; height: 15rem;">
                    <div class="mt-3">
                        <#if usuario??>
                            <h1 class="fw-bold text-success">4<span style="color:black;">01!</span></h1>
                            <a class="btn btn-success" href="/carrito/login/iniciarSesion">Cambiar sesión</a>
                             <a class="btn btn-primary" href="/carrito/comprar">Seguir en Tienda</a>
                        <#else>
                            <h1 class="fw-bold text-success">4<span style="color:black;">01!</span></h1>
                            <a class="btn btn-success" href="/carrito/login/iniciarSesion">Iniciar sesión</a>
                            <a class="btn btn-primary" href="/carrito/comprar">Seguir en Tienda</a>
                        </#if>
                    </div>
                </div>
