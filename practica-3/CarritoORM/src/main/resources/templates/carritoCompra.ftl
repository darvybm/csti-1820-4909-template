        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="navbar" aria-labelledby="navbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-success" href="/carrito/carritoCompra">Carrito de Compras</a>
                    </li>
...
<!--Listado de productos (Mangas) agregador al carrito-->
...
<div class="bg-image text-center lg-auto"
    ...
    <div class="py-4">
        <h1 class="display-2 fw-bold text-success"><#if usuario??>${usuario.usuario[0]}<#else>G</#if><span
                    style="color:white;"><#if usuario??>${usuario.usuario?substring(1)}<#else>uest</#if></span></h1>
        <div class="col-lg-6 mx-auto">
            <p class="fs-5 mb-4 text-white"><#if usuario??>${usuario.admin?then("Usuario Administrador", "Usuario Normal")}<#else>Invitado</#if></p>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <#if datos?has_content>
        <div style="margin: 5%">
            <h1 class="fw-bold text-success">C<span style="color:black;">arrito</span></h1>
                ...
                <table class="table table-striped">
                    ...
                    <#list datos as carritoItem>
                        <tr>
                            ...
                            <td><img src="data:image/${carritoItem.getProducto().fotosBase64[0].type};base64,${carritoItem.getProducto().fotosBase64[0].foto}"
                                     style="height: 8rem; width: 6rem; object-fit: cover"></td>
                            <td>
                                <a href="/carrito/carritoCompra/eliminar/${carritoItem.getProducto().id}"
                    ...
                    <tr style="font-size: 1.2rem; font-weight: bold; color: seagreen">
                        <td colspan="4"></td>
                        <td colspan="3">Precio total: ${totalCarrito}$</td>
                    </tr>
                    </tfoot>
                </table>
            </div>
            <form method="post" action="/carrito/carritoCompra/">
                <button class="btn btn-success p-2 mt-4 ml-2" type="submit">Procesar Compra</button>
            </form>
        </div>
    <#else>
        <div class="container text-center">
            ...
            <div class="mt-3">
                <h1 class="fw-bold text-success">C<span style="color:black;">arrito Vacio!</span></h1>
                <h4 class="text-secondary" style="margin: 0 5rem;">Agrega algo palomo</h4>
